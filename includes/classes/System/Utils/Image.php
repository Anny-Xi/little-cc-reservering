...
class Image
{
    ...
    public function save(array $uploadFile): string
    {
        ...
        $fileName = sha1_file($uploadFile['tmp_name']) . 'Utils' . $ext;
        if (!move_uploaded_file($uploadFile['tmp_name'], sprintf('./uploaded_img/%s', $fileName))) {
    ...
    public function delete(string $fileName): bool
    {
        ...
        $removed = unlink('./uploaded_img/' . $fileName);
