    ...
    <form class="column is-6" action="" method="post" enctype="multipart/form-data">
        <div class="field is-horizontal">
            <div class="field-label is-normal">
                <label class="label" for="admin_userName">Email</label>
            </div>
            <div class="field-body">
                <input class="input" id="email" type="text" name="admin_userName" value="<?= $admin_userName ?? ''; ?>"/>
            </div>
        </div>
        <div class="field is-horizontal">
            <div class="field-label is-normal">
...
<a class="button mt-4" href="<?= BASE_PATH; ?>admin_register">&laquo; Go register</a>
